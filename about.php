    ...
    <main class="about-page">
        ...
        <section class="journey-section-about">
            ...
            <div class="intro-text-about reveal-about">
                <p>
                  Rua is a multi-dimensional venture built on over a decade of experience across international education, oud and agarwood craftsmanship, and curated recreation. With roots in Sri Lanka and a reach that extends globally, we bring together ambition, well-being, and experience in ways that are both grounded and quietly distinctive. Through Rua Eduventure, we guide students to global academic destinations with clarity and care. With Rua El Oud, we craft and source rare agarwood and oud oils that awaken the senses and hold centuries of quiet tradition. And with Rua Recreation, we offer spaces for movement, rest, and reconnection — from holiday rentals and Zumba fitness to indoor sports and meditation. <br><br>Each arm of Rua is connected by a simple idea: that a meaningful life isn’t loud, it’s intentional. What we offer may seem different. But when you experience it, It just feels right.
